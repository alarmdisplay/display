...
class Database {
  ...
  async start () {
    ...
    return {
      ...
      contentSlotRepository: new ContentSlotRepository(this, `${this.prefix}contentslots`, `${this.prefix}contentslot_options`),
  ...
  initialize (connection) {
    ...
    const tableDefinitions = {
      ...
      alerts: '(`id` int(10) unsigned NOT NULL AUTO_INCREMENT, `title` varchar(200) NOT NULL, `keyword` varchar(100) NOT NULL, `description` text NOT NULL DEFAULT \'\', `time` timestamp NOT NULL DEFAULT current_timestamp(), `location` varchar(250) NOT NULL DEFAULT \'\', `status` varchar(20) NOT NULL, `category` varchar(20) NOT NULL DEFAULT \'Other\', `contact` varchar(150) NOT NULL DEFAULT \'\', `expires` timestamp NULL DEFAULT NULL, `updated` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(), PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4',
