...
module.exports = function (controller) {
    ...
    router.get('/', async (req, res, next) => {
        try {
            let displays = await controller.findDisplays();
            res.json(displays);
        } catch (e) {
            return next(e);
        }
    ...
    router.post('/displays', async (req, res, next) => {
        try {
            let display = await controller.createDisplay(req.body.identifier, req.body.active, req.body.description, req.body.location);
    ...
    router.get('/displays/:id', async (req, res, next) => {
        try {
            let display = await controller.findDisplay(req.params.id);
            if (!display) {
    ...
    router.put('/:id', async (req, res, next) => {
        try {
            let display = await controller.updateDisplay(req.params.id, req.body);
            res.json(display);
        } catch (e) {
            return next(e);
        }
